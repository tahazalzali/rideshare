...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Book a new trip' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Trip request accepted' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get trip status by id' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Trip found' }),
