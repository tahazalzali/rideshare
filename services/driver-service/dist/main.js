...
async function bootstrap() {
    await (0, common_1.initTracing)('driver-service');
    ...
    const doc = new swagger_1.DocumentBuilder().setTitle('Driver Service').setVersion('1.0').build();
    ...
    app.connectMicroservice({
        ...
        options: {
            ...
            queue: process.env.QUEUE_DRIVER || 'driver_queue',
