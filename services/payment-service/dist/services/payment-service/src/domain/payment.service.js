...
const payment_auth_entity_1 = require("./payment-auth.entity");
let PaymentService = class PaymentService {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
    async authorize(tripId, passengerId, amount) {
...
exports.PaymentService = PaymentService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(payment_auth_entity_1.PaymentAuth)),
